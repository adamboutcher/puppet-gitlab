...
class gitlab::repos::ce::yum {
  ...
  yumrepo { 'gitlab_gitlab-ce':
    ...
    enabled             => 1,
    repo_gpgcheck       => 1,
    gpgkey              => 'https://packages.gitlab.com/gitlab/gitlab-ce/gpgkey https://packages.gitlab.com/runner/gitlab-runner/gpgkey/runner-gitlab-runner-4C80FB51394521E9.pub.gpg',
    gpgcheck            => 1,
    sslverify           => 1,
    sslcacert           => '/etc/pki/tls/certs/ca-bundle.crt',
    skip_if_unavailable => 1,
